	...
	<div class="container">
		<div class="row no-gutters slider-text align-items-end justify-content-center">
			<div class="col-md-9 ftco-animate pb-5 text-center">
				<h1 class="mb-3 bread">Bài viết</h1>
			</div>
		</div>
	</div>
</section>
...
<section class="ftco-section">
	<div class="container">
		<div class="row">
			<div class="col-lg-9">
				<div class="row">
					<?php foreach ($posts as $key => $value) { $created_at=  date ("jS M Y", strtotime($value['created_at']));?>
					...
					<div class="col text-center">
						<div class="block-27">
							<ul>
								...
								<li><a href="?mod=client&c=post&act=index&i=<?= $i?>"><?= $i?></a></li>
								<?php } ?> -->
							</ul>
						</div>
					</div>
